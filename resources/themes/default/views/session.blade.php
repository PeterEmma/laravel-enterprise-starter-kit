            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-header">
				 ...
				 <form action="store_message" method="post" enctype="multipart/form-data">
                <div class="box-body">
			  ...
			  <div class="box box-success">
                ...
                <form action="store-session" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Folder Name</label>
                      <input type="text" class="form-control" name="fold_name"  placeholder="File Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Folder Description</label>
                      <input type="text" class="form-control" name="fold_desc" placeholder="File Description">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputPassword1">Clearance Level</label>
                      <select type="text" class="form-control" name="clearance_level" placeholder="Folder By">
					  <option>1</option>
					  <option>2</option>
					  <option>3</option>
					  <option>4</option>
					...
					<input type="hidden" name="folder_by" value="{{ Auth::user()->email }}">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
                    </div><!-- /.box-body -->
