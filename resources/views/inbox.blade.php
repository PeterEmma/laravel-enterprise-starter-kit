              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="inbox"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">12</span></a></li>
                      ...
                      <tbody>
					   @foreach($message as $user)
                        <tr>
                          ...
                          <td class="mailbox-star"><a href='show-message/{{ $user->id }}'><i class="fa fa-star text-yellow"></i></a></td>
                          <td class="mailbox-name"><a href='show-message/{{ $user->id }}'>Alexander Pierce</a></td>
                          <td class="mailbox-subject"><b>{{ $user->subject }}</b> - {{ $user->message }}</td>
