<div class="row">
  ...
  <div class="col-md-4">
    <div class="text-center">
      ...
      <button class="btn btn-primary" onclick="performCrop()">{{ trans('registry/lfm.btn-crop') }}</button>
      <button class="btn btn-info" onclick="loadItems()">{{ trans('registry/lfm.btn-cancel') }}</button>
      <form id='cropForm'>
