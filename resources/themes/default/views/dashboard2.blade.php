          ...
          <div class="box box-success">
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>From: {{ $user->folder_by }} <span id="read-time" class="mailbox-read-time pull-right">{{ $user->created_at }}</span></h5>
              ...
              <div class="mailbox-read-message">			  
                    ...
                    @if ($folder_id === reset($file))   
                      <?php $pdf = $folder_id->name ?>
                    @endif
          				@endif
        				@endforeach
        				<object data="/files/{{ $user->latest_doc }}" type="application/pdf" width="680" height="450">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <!-- chat item -->
    	        @foreach($comment as $folder_id)
              	@if($folder_id->folder_id == $user->id)
                  <div class="item">
                    <!-- @cpnwaugha: c-e: Fetching the user's image -->
            ...
            <!-- Form to receive user's comment.-->
    				<form action="comment" method="post" enctype="multipart/form-data">
      				...
      				<input type="hidden" name="folder_id" value="{{ $user->id }}">
      				<input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="box-footer">
                <div class="input-group">
                  <input class="form-control" name="comment" placeholder="Type message..."/>
                  <div class="input-group-btn">
                    <button class="btn btn-success"><i class="fa fa-plus"> Post</i></button>
                  </div>
                </div>
              </div>
    				</form>
            ...
            <div class="box-footer">
              ...
              <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                    <div class="pull-right">
                        ...
                        <div class="input-group-btn">
                          <button class="btn btn-primary"><i class="fa fa-share"></i> Forward</button>
                        </div>
                      </div>                   
                    </div>
